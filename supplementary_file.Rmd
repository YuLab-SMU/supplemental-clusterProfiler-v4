...
Here, we compare `clusterProfiler` with other R packages that also can perform functional enrichment analysis (Table S2). The packages in Table S2 was ordered by monthly download stats (April 2021). 
